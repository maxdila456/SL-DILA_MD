...
const sessdata = config.SESSION_ID.replace("KUKKU-PANDA-MD~", '');
...
console.log("Session downloaded ✅")
  ...
  let up = `*Hello there KUKKU PANDA User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet KUKKU PANDA MD WhatsApp Bot.\n\n *Thanks for using KUKKU PANDA \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VavmARiCBtxJYzjJKn16\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com\n\n> © Powered BY ᴋᴜᴋᴋᴜ ᴘᴀɴᴅᴀ\ud83d\udda4`;
  conn.sendMessage(conn.user.id, { image: { url: `https://bit.ly/4h4uwnr` }, caption: up })
  }
  })
